...
/******/
/************************************************************************/
var __webpack_exports__ = {}; // ./web/pdfjs.js
...
class Sidebar {
  ...
  #makeSidebarResizable() {
    ...
    this.#resizer.addEventListener("pointerdown", (e) => {
      ...
      window.addEventListener(
        ...
        (ev) => {
          ...
          stopEvent(ev);
          sidebarStyle.width = `${Math.round(
            this.#width + this.#coefficient * (ev.clientX - this.#prevX)
          )}px`;
        },
        {
          signal,
    ...
    this.#resizer.addEventListener("keydown", (e) => {
      ...
      if (isArrowLeft || key === "ArrowRight") {
        ...
        sidebarStyle.width = `${Math.round(
          this.#width + this.#coefficient * dx
        )}px`;
        stopEvent(e);
      }
    });
  ...
  #setWidth(newWidth) {
    ...
    if (this.#isResizerOnTheLeft) {
      this._sidebar.parentElement.style.insetInlineStart = `${(
