...
async def accessTokenValidation(
    headerToken: Optional[str] = Depends(oauth2),
    queryToken: Optional[str] = Query(default=None, alias="token"),
) -> str:
...
async def getS3Client(request: Request) -> S3Client:
